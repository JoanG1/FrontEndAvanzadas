...
const RegisterForm: React.FC = () => {
    ...
    const {
       ...
       watch,
       formState: { errors },
    } = useForm<FormDataRegister & { confirmarContrasena: string }>();
             ...
             <form onSubmit={handleSubmit(onSubmit)} className="register-form">
                ...
                <div className="register-input-wrapper">
                   <input
                      ...
                      className="register-input"
                   />
                   <span className="register-eye" onClick={() => setMostrarContrasena(!mostrarContrasena)}>
                ...
                <div className="register-input-wrapper">
                   <input
                      {...register('confirmarContrasena', {
                         ...
                         validate: (value) =>
                            value === contrasenaActual || 'Las contraseñas no coinciden',
                      })}
                      type={mostrarConfirmar ? 'text' : 'password'}
                      placeholder="Confirmar contraseña"
                      className="register-input"
                   />
                   <span className="register-eye" onClick={() => setMostrarConfirmar(!mostrarConfirmar)}>
                      {mostrarConfirmar ? <FaEyeSlash /> : <FaEye />}
                   </span>
                </div>
                {errors.confirmarContrasena && <p className="register-error">{errors.confirmarContrasena.message}</p>}
